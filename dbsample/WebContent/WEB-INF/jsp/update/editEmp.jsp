				...
				<form class="edit-form">
					<table>
						...
						<tr>
							<th>誕生日</th>
							<td>
								<input type="text" name="birthday" value="<c:out value="${emp.birthday}" />">
							</td>
						</tr>
						<tr>
							<th>部署</th>
					...
					<div class="btn-area">
						...
						<input type="submit" class="submit-btn" value="確認" formmethod="post"
						       formaction="${pageContext.request.contextPath}/updateConfirm">
					</div>
				</form>
